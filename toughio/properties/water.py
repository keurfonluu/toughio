...
def density(
    ...
    if method == "IFC67":
        A = [
            6824.687741, -542.2063673, -20966.66205,
            39412.86787, -67332.77739, 99023.81028,
            -109391.1774, 85908.41667, -45111.68742,
            14181.38926, -2017.271113, 7.982692717,
            -2.616571843e-2, 1.52241179e-3, 2.284279054e-2,
            242.1647003, 1.269716088e-10, 2.074838328e-7,
            2.17402035e-8, 1.105710498e-9, 12.93441934,
            1.308119072e-5, 6.047626338e-14,
        ]
        SA = [
            0.8438375405, 5.362162162e-4, 1.72,
            7.342278489e-2, 4.97585887e-2, 0.6537154300,
            1.15e-6, 1.1508e-5, 0.14188,
            7.002753165, 2.995284926e-4, 0.204,
        ]
        ...
        PAR2 = A[12] + A[13] * TKR + A[14] * TKR2 + A[15] * (SA[5] - TKR) ** 10 + A[16] / (SA[6] + TKR8 * TKR11)
        PAR3 = (A[17] + 2.0 * A[18] * PNMR + 3.0 * A[19] * PNMR2) / (SA[7] + TKR11)
        PAR4 = A[20] * TKR8 * TKR10 * (SA[8] + TKR2) * (-3.0 / (SA[9] + PNMR) ** 4 + SA[10])
