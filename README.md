...
-   Import previous TOUGH simulation input file into Python or define simulation parameters in a human-readable and jsonable dictionary [JSON](http://json.org/),
